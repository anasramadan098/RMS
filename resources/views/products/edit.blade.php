                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="order" class="form-control" id="order" value="{{ old('order', $meal->order) }}" min="0" placeholder="0">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="expiration_date" class="form-control" id="expiration_date" value="{{ old('expiration_date' , $meal->expiration_date) }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="discount_number" class="form-label">{{ __('meals.discount_number') }}</label>
                                    <input type="number" name="discount_number" class="form-control" id="discount_number" value="{{ old('discount_number' , $meal->discount_number) }}" min="0" step="0.01" placeholder="{{__('meals.placeholders.discount')}}">
                                </div>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const mealSizes = @json($meal->sizes ?? []);

    function addSize(sizeData = null) {
        ...
        if (sizeData) {
            row.querySelector('input[name$="[name_ar]"]').value = sizeData.name_ar || '';
            row.querySelector('input[name$="[name_en]"]').value = sizeData.name_en || '';
            row.querySelector('input[name$="[price]"]').value = sizeData.price || '';
            row.querySelector('input[name$="[sort_order]"]').value = sizeData.sort_order || '';
        }
    ...
    if (mealSizes && mealSizes.length > 0) {
        mealSizes.forEach(size => addSize(size));
    }
    ...
    const mealExtras = @json($meal->extras ?? []);

    function addExtra(extraData = null) {
        ...
        if (extraData) {
            row.querySelector('input[name$="[name_ar]"]').value = extraData.name_ar || '';
            row.querySelector('input[name$="[name_en]"]').value = extraData.name_en || '';
            row.querySelector('input[name$="[price]"]').value = extraData.price || '';
            row.querySelector('select[name$="[category]"]').value = extraData.category || '';
            row.querySelector('input[name$="[sort_order]"]').value = extraData.sort_order || '';
        }
    ...
    if (mealExtras && mealExtras.length > 0) {
        mealExtras.forEach(extra => addExtra(extra));
    }
